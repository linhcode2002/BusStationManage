# Generated by Django 5.0.3 on 2024-09-29 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance', models.DecimalField(decimal_places=0, default=0, max_digits=5)),
                ('bus', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='BusManage.bus')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_payment', models.DecimalField(decimal_places=0, default=0, max_digits=12)),
